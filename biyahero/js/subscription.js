...
const SubscriptionManager = {
        ...
        overlay.innerHTML = `
            ...
            <div class="bh-plan-modal" role="dialog" aria-modal="true" aria-labelledby="bh-plan-title">
                ...
                <div class="bh-plans-grid">
                    ...
                    ${getPlanCard('basic', 'Basic', '🚎', '₱99', basicFeatures)}
        ...
        modal.innerHTML = `
            ...
            <div class="payment-modal">
                ...
                <div class="payment-body">
                    ...
                    <button class="pay-btn" onclick="SubscriptionManager.simulatePayment()">Pay ₱99</button>
    ...
    simulatePayment: function () {
        ...
        const email = localStorage.getItem('biyahero_user_email');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const currentUser = localStorage.getItem('biyahero_user_email');
